...
{
    public class NXTColorSensorComponent : ControllableComponent
    {
        private NXTColorSensor colorSensor;

        public NXTColorSensorComponent(string componentName, ControllableComponent parent, NXTColorSensor colorSensor) : base(componentName, parent)
        {
